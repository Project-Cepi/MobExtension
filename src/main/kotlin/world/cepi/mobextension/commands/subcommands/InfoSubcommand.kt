...
internal object InfoSubcommand : Command("info") {
    ...
    private fun skimMobProperties(propertyName: String, unknownProperty: String, properties: Collection<Any>): Component {
        ...
        addSyntax { sender ->
            ...
            player.sendMessage(
                skimMobProperties("Meta", "Unknown Meta", mob.properties.metas)
                    ...
                    .append(Component.newline())
                    .append(skimMobProperties("Targets", "Unknown Target", mob.properties.targets))
                    .append(Component.newline())
